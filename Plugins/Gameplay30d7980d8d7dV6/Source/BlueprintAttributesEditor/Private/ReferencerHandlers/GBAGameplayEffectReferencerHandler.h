...
protected:
	...
	/** Common code shared between modifiers backing attribute and duration */
	static bool UpdateGameplayEffectModifierMagnitude(FGameplayModifierInfo& InOutModifier, const FAttributeReference& CachedAttribute, const UBlueprint* InBlueprint, const FGBAAttributeReferencerPayload& InPayload);

	static bool UpdateGameplayEffectModifierMagnitude(FGameplayEffectModifierMagnitude& InOutModifierMagnitude, const FAttributeReference& CachedAttribute, const UBlueprint* InBlueprint, const FGBAAttributeReferencerPayload& InPayload);
	...
	static FAttributeBasedFloat* GetAttributeBasedFloatFromContainer(FGameplayEffectModifierMagnitude* InModifierMagnitude);
