...
#include "GBAGameplayEffectReferencerHandler54.h"
...
TSharedPtr<IGBAAttributeReferencerHandler> FGBAGameplayEffectReferencerHandler54::Create()
{
	return MakeShared<FGBAGameplayEffectReferencerHandler54>();
}

FGBAGameplayEffectReferencerHandler54::~FGBAGameplayEffectReferencerHandler54()
{
	AttributesCacheMap.Reset();
}

void FGBAGameplayEffectReferencerHandler54::OnPreCompile(const FString& InPackageName)
{
	AttributesCacheMap.Reset();
}

void FGBAGameplayEffectReferencerHandler54::OnPostCompile(const FString& InPackageName)
{
}

bool FGBAGameplayEffectReferencerHandler54::HandlePreCompile(const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload)
{
...
bool FGBAGameplayEffectReferencerHandler54::HandleAttributeRename(const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
	GBA_EDITOR_NS_LOG(Verbose, TEXT("InAssetIdentifier: %s, InPayload: %s"), *InAssetIdentifier.ToString(), *InPayload.ToString())
...
bool FGBAGameplayEffectReferencerHandler54::HandleAttributeRemoved(const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
	return false;
}

bool FGBAGameplayEffectReferencerHandler54::BuildModifierInfoAttributeReference(const FGameplayModifierInfo& InModifier, FAttributeReference& OutAttributeReference)
{
...
bool FGBAGameplayEffectReferencerHandler54::BuildModifierMagnitudeAttributeReference(const FGameplayEffectModifierMagnitude& InMagnitude, FAttributeReference& OutAttributeReference)
{
...
bool FGBAGameplayEffectReferencerHandler54::BuildEffectCueMagnitudeAttributeReference(const FGameplayEffectCue& InEffectCue, FAttributeReference& OutAttributeReference)
{
	FString FinalValue;
...
bool FGBAGameplayEffectReferencerHandler54::BuildEffectQueryAttributeReference(const FGameplayEffectQuery& InEffectQuery, FAttributeReference& OutAttributeReference)
{
	FString FinalValue;
...
bool FGBAGameplayEffectReferencerHandler54::UpdateModifiers(UGameplayEffect* InEffectCDO, const UBlueprint* InBlueprint, const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
...
bool FGBAGameplayEffectReferencerHandler54::UpdateModifiersBackingAttribute(UGameplayEffect* InEffectCDO, const UBlueprint* InBlueprint, const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
	GBA_EDITOR_NS_LOG(Display, TEXT("InEffectCDO: %s, InBlueprint: %s, InOldPropertyName: %s, InNewPropertyName: %s"),
		*GetNameSafe(InEffectCDO),
		*GetNameSafe(InBlueprint),
...
bool FGBAGameplayEffectReferencerHandler54::UpdateDuration(UGameplayEffect* InEffectCDO, const UBlueprint* InBlueprint, const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
	GBA_EDITOR_NS_LOG(
		Verbose,
...
bool FGBAGameplayEffectReferencerHandler54::UpdateCues(UGameplayEffect* InEffectCDO, const UBlueprint* InBlueprint, const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
	GBA_EDITOR_NS_LOG(
		Verbose,
...
bool FGBAGameplayEffectReferencerHandler54::UpdateRemoveGameplayEffectQuery(UGameplayEffect* InEffectCDO, const UBlueprint* InBlueprint, const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
#if UE_VERSION_NEWER_THAN(5, 3, -1)
...
bool FGBAGameplayEffectReferencerHandler54::UpdateImmunityEffectQuery(UGameplayEffect* InEffectCDO, const UBlueprint* InBlueprint, const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
#if UE_VERSION_NEWER_THAN(5, 3, -1)
...
bool FGBAGameplayEffectReferencerHandler54::UpdateEffectQuery(const UBlueprint* InBlueprint, const FAssetIdentifier& InAssetIdentifier, EAttributeReferenceType InReferenceType, const FGBAAttributeReferencerPayload& InPayload, const FText& InMessageText, FGameplayAttribute& OutModifyingAttribute, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
...
FAttributeBasedFloat* FGBAGameplayEffectReferencerHandler54::GetAttributeBasedFloatFromContainer(FGameplayEffectModifierMagnitude* InModifierMagnitude) const
{
...
FString FGBAGameplayEffectReferencerHandler54::GetClassDefaultName(const FString& InName)
{
	FString Name = InName;
