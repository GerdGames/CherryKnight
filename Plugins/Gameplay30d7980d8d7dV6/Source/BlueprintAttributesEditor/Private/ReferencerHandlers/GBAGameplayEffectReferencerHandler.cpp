...
bool FGBAGameplayEffectReferencerHandler::HandleAttributeRemoved(const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
	GBA_EDITOR_NS_LOG(Verbose, TEXT("InAssetIdentifier: %s, InPayload: %s"), *InAssetIdentifier.ToString(), *InPayload.ToString())
...
bool FGBAGameplayEffectReferencerHandler::BuildModifierInfoAttributeReference(const FGameplayModifierInfo& InModifier, FAttributeReference& OutAttributeReference)
{
	...
	{
		GBA_EDITOR_NS_LOG(Verbose, TEXT("Invalid modifier"))
		return false;
	}
...
bool FGBAGameplayEffectReferencerHandler::UpdateModifiers(UGameplayEffect* InEffectCDO, const UBlueprint* InBlueprint, const FAssetIdentifier& InAssetIdentifier, const FGBAAttributeReferencerPayload& InPayload, TArray<TSharedRef<FTokenizedMessage>>& OutMessages)
{
	...
	GBA_EDITOR_LOG(Verbose, TEXT("UGBAEditorSubsystem::UpdateGameplayEffectModifiers Update CDO modifiers now from gathered props to reset: %d"), ModifiersToReset.Num())
...
bool FGBAGameplayEffectReferencerHandler::UpdateGameplayEffectModifierMagnitude(FGameplayModifierInfo& InOutModifier, const FAttributeReference& CachedAttribute, const UBlueprint* InBlueprint, const FGBAAttributeReferencerPayload& InPayload)
{
...
bool FGBAGameplayEffectReferencerHandler::UpdateGameplayEffectModifierMagnitude(FGameplayEffectModifierMagnitude& InOutModifierMagnitude, const FAttributeReference& CachedAttribute, const UBlueprint* InBlueprint, const FGBAAttributeReferencerPayload& InPayload)
{
...
FAttributeBasedFloat* FGBAGameplayEffectReferencerHandler::GetAttributeBasedFloatFromContainer(FGameplayEffectModifierMagnitude* InModifierMagnitude)
{
